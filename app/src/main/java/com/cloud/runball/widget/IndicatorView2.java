 ...
 * @Description:
 * @Author: zhd
 * @CreateDate: 2021/6/17 14:35
 * @UpdateUser: zhd
 * @UpdateDate: 2021/6/17 14:35
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class IndicatorView2 extends View implements Indicator {
    ...
    @IntDef({IndicatorView2.IndicatorStyle.INDICATOR_CIRCLE,
            IndicatorView2.IndicatorStyle.INDICATOR_CIRCLE_RECT,
            IndicatorView2.IndicatorStyle.INDICATOR_BEZIER,
            IndicatorView2.IndicatorStyle.INDICATOR_DASH,
           IndicatorView2.IndicatorStyle.INDICATOR_BIG_CIRCLE})
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (indicatorStyle == IndicatorView2.IndicatorStyle.INDICATOR_CIRCLE) {
            drawCircle(canvas, midY);
        } else if (indicatorStyle == IndicatorView2.IndicatorStyle.INDICATOR_CIRCLE_RECT) {
            drawCircleRect(canvas, midY);
        } else if (indicatorStyle == IndicatorView2.IndicatorStyle.INDICATOR_BEZIER) {
            drawBezier(canvas, midY);
        } else if (indicatorStyle == IndicatorView2.IndicatorStyle.INDICATOR_DASH) {
            drawDash(canvas, midY);
        } else if (indicatorStyle == IndicatorView2.IndicatorStyle.INDICATOR_BIG_CIRCLE) {
    ...
    private float indicatorStartX(int index) {
         ...
         */
        return centerX + (indicatorStyle == IndicatorView2.IndicatorStyle.INDICATOR_DASH ? 0 : (ratioIndicatorRadius - ratioRadius) / 2);
    }
     ...
     */
    public IndicatorView2 setIndicatorRadius(float indicatorRadius) {
     ...
     * {@link IndicatorView2#getRatioRadius()}
     *
     * @param indicatorRatio indicatorRadius * indicatorRatio
     */
    public IndicatorView2 setIndicatorRatio(float indicatorRatio) {
     ...
     */
    public IndicatorView2 setIndicatorSelectedRadius(float indicatorSelectedRadius) {
     ...
     */
    public IndicatorView2 setIndicatorSelectedRatio(float indicatorSelectedRatio) {
     ...
     */
    public IndicatorView2 setIndicatorSpacing(float indicatorSpacing) {
        this.indicatorSpacing = dip2px(indicatorSpacing);
        return this;
    }

    public IndicatorView2 setIndicatorStyle(@IndicatorView2.IndicatorStyle int indicatorStyle) {
        this.indicatorStyle = indicatorStyle;
        return this;
    }

    public IndicatorView2 setIndicatorColor(@ColorInt int indicatorColor) {
        this.unColor = indicatorColor;
        return this;
    }

    public IndicatorView2 setIndicatorSelectorColor(@ColorInt int indicatorSelectorColor) {
        this.selectedColor = indicatorSelectorColor;
        return this;
    }

    public IndicatorView2 setParams(RelativeLayout.LayoutParams params) {
        this.params = params;
        return this;
    }
}
