 ...
 * @Description:
 * @Author: zhd
 * @CreateDate: 2021/6/17 14:55
 * @UpdateUser: zhd
 * @UpdateDate: 2021/6/17 14:55
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class Banner2 extends RelativeLayout {
    ...
    private Banner2.BannerAdapterWrapper adapterWrapper;
    ...
    private void initViews(final Context context) {
        ...
        viewPager2.registerOnPageChangeCallback(new Banner2.OnPageChangeCallback());
        viewPager2.setAdapter(adapterWrapper = new Banner2.BannerAdapterWrapper());
    ...
    private void initViewPagerScrollProxy() {
        try {
            ...
            Banner2.ProxyLayoutManger proxyLayoutManger = new Banner2.ProxyLayoutManger(getContext(), o);
     ...
     */
    public Banner2 setPageMargin(int multiWidth, int pageMargin) {
     ...
     * @param pageMargin item与item之间的宽度
     */
    public Banner2 setPageMargin(int tlWidth, int brWidth, int pageMargin) {
        if (pageMargin < 0) {
            pageMargin = 0;
        }
    ...
    public Banner2 addPageTransformer(ViewPager2.PageTransformer transformer) {
        compositePageTransformer.addTransformer(transformer);
        return this;
    }

    public Banner2 setAutoTurningTime(long autoTurningTime) {
        this.autoTurningTime = autoTurningTime;
        return this;
    }

    public Banner2 setOuterPageChangeListener(ViewPager2.OnPageChangeCallback listener) {
     ...
     * 设置viewpager2的切换时长
     */
    public Banner2 setPagerScrollDuration(long pagerScrollDuration) {
     ...
     */
    public Banner2 setOrientation(@ViewPager2.Orientation int orientation) {
        viewPager2.setOrientation(orientation);
        return this;
    }

    public Banner2 addItemDecoration(@NonNull RecyclerView.ItemDecoration decor) {
        viewPager2.addItemDecoration(decor);
        return this;
    }

    public Banner2 addItemDecoration(@NonNull RecyclerView.ItemDecoration decor, int index) {
     ...
     * 是否自动轮播 大于1页轮播才生效
     */
    public Banner2 setAutoPlay(boolean autoPlay) {
        isAutoPlay = autoPlay;
     ...
     */
    public Banner2 setIndicator(Indicator indicator, boolean attachToRoot) {
    ...
    public Banner2 setRoundCorners(final float radius) {
