 ...
 * @Description:
 * @Author: zhd
 * @CreateDate: 2021/3/25 9:59
 * @UpdateUser: zhd
 * @UpdateDate: 2021/3/25 9:59
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class AgreementDialog extends Dialog {
    ...
    public AgreementDialog(Context context, SpannableString content, String strContent, String title) {
        ...
        this.btnName = this.context.getString(R.string.lbl_privacy_agress);
        this.no = this.context.getString(R.string.lbl_privacy_noagress);
    }

    //构造方法
    public AgreementDialog(Context context, SpannableString content, String strContent) {
        super(context, R.style.DialogTheme);
        this.context = context;
        this.str = content;
        this.strContent = strContent;
        this.title = this.context.getString(R.string.tip);
