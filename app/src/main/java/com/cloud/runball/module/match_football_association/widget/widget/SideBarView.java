package com.cloud.runball.module.match_football_association.widget.widget;
...
//    private static final double SCALING_RATIO = 0.85;
    private static final double SCALING_RATIO = 1;
    ...
    public void updateListView(List<String> data) {
        this.characters = data.toArray(new String[0]);
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < characters.length; i++) {
            ...
            // x坐标等于中间-字符串宽度的一半.
            float xPos = (width >> 1) - paint.measureText(characters[i]) / 2;
