 ...
 * @ClassName: MineMatchAdapter
 * @Description:
 * @Author: zhd
 * @CreateDate: 2021/5/12 10:21
 * @UpdateUser: zhd
 * @UpdateDate: 2021/5/12 10:21
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class MineMatchAdapter extends RecyclerView.Adapter<MineMatchAdapter.ViewHolder>{
  ...
  public MineMatchAdapter(Context context, List<MatchRankInfoData> infos) {
    this.mContext = context;
    this.dataInfo = infos;
  }

  public void notifyDataSetChanged(List<MatchRankInfoData> infos) {
    this.dataInfo = infos;
  ...
  public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    viewHolder.btnAttendDetail.setOnClickListener(v -> {
      ...
      if (onItemClickListener != null) {
        onItemClickListener.onItemClick(OnItemClickListener.BUTTON, dataInfo.get(position));
      }
    });
    //点击item的监听器
    viewHolder.myView.setOnClickListener(v -> {
      ...
      if (onItemClickListener != null) {
        onItemClickListener.onItemClick(OnItemClickListener.DETAIL, dataInfo.get(position));
      }
    });
    return viewHolder;
  }
  ...
  public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
    MatchRankInfoData data = dataInfo.get(position);
...
//    }
  ...
  public interface OnItemClickListener {
    ...
    int DETAIL = 1;
    int RANK = 2;
    void onItemClick(int type, MatchRankInfoData data);
  }
...
//  List<MatchRankInfoData> dataInfo;
//  Context mContext;
//
//  public MineMatchAdapter(Context context, List<MatchRankInfoData> infos) {
//    this.mContext = context;
...
//  }
//
//  private MineMatchAdapter.OnItemClickListener onItemClickListener;
//
//
//  public void setOnItemClickListener(MineMatchAdapter.OnItemClickListener onItemClickListener) {
//    this.onItemClickListener = onItemClickListener;
//  }
//
//  @NonNull
//  @Override
//  public MineMatchAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mine_match_layout_item, null);
//    final MineMatchAdapter.ViewHolder viewHolder = new MineMatchAdapter.ViewHolder(view);
//    viewHolder.btnAttendDetail.setOnClickListener(v -> {
//      int postion = viewHolder.getLayoutPosition()-1;
//      if (onItemClickListener != null) {
//        int status=dataInfo.get(postion).getMatch_status();
//        onItemClickListener.onItemClick(status==3?OnItemClickListener.RANK:OnItemClickListener.NONE,dataInfo.get(postion));
//      }
//    });
//
//    viewHolder.ivRank.setOnClickListener(v -> {
//      int postion = viewHolder.getLayoutPosition()-1;
//      if (onItemClickListener != null) {
//        onItemClickListener.onItemClick(OnItemClickListener.RANK,dataInfo.get(postion));
//      }
//    });
//
//    viewHolder.myView.setOnClickListener(v -> {
//      int postion = viewHolder.getLayoutPosition()-1;
//      if (onItemClickListener != null) {
//        onItemClickListener.onItemClick(OnItemClickListener.DETAIL,dataInfo.get(postion));
//      }
//    });
//    return viewHolder;
//  }
//
//  @Override
//  public void onBindViewHolder(@NonNull MineMatchAdapter.ViewHolder holder, int position) {
//    MatchRankInfoData data= dataInfo.get(position);
//
...
//    }else if(data.getMatch_status()==3){
//      //已结束
...
//    if(data.getIs_group()==0){
//      holder.tvGroup.setText(R.string.lbl_match_corner_tip_1);
//    }else if(data.getIs_group()==1){
//      holder.tvGroup.setText(R.string.lbl_match_corner_tip_3);
//    }
//
//
//    holder.tvPerson.setText(String.format(mContext.getResources().getString(R.string.lbl_match_sign_num),data.getMatch_user_sign_count()));
...
//    int DETAIL=1;
//    int RANK=2;
//    void onItemClick(int goType,MatchRankInfoData data);
//  }
}
