...
public class WheelTime {
    ...
    private static final int DEFAULT_START_DAY = 0;
    ...
    public WheelTime(View view, boolean[] type, boolean isFullMonth, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
        ...
        if (startYear == endYear && startMonth == endMonth) {
            ...
            if (list_big.contains(String.valueOf(month + 1))) {
                ...
                wv_day.setAdapter(new NumericWheelAdapter(isFullMonth ? 0 : 1, endDay));
            } else if (list_little.contains(String.valueOf(month + 1))) {
                if (endDay > 30) {
                    endDay = 30;
                }
            ...
            // 判断大小月及是否闰年,用来确定"日"的数据
            if (list_big.contains(String.valueOf(month + 1))) {
                wv_day.setAdapter(new NumericWheelAdapter(isFullMonth ? 0 : 1, 31));
            } else if (list_little.contains(String.valueOf(month + 1))) {
                wv_day.setAdapter(new NumericWheelAdapter(isFullMonth ? 0 : 1, 30));
            } else {
                // 闰年 29，平年 28
                wv_day.setAdapter(new NumericWheelAdapter(startDay, leapYear ? 29 : 28));
            }
            ...
            public void onItemSelected(int index) {
                ...
                if (startYear == endYear) {
                    ...
                    if (startMonth == endMonth) {
                        ...
                        setReDay(year_num, monthNum, isFullMonth ? 0 : 1, endDay, list_big, list_little);
                    } else {//重新设置日
                        setReDay(year_num, monthNum, isFullMonth ? 0 : 1, 31, list_big, list_little);
                    }
                    ...
                    if (month == startMonth) {
                        ...
                        //重新设置日
                        setReDay(year_num, month, isFullMonth ? 0 : 1, 31, list_big, list_little);
                    }
                    ...
                    wv_month.setAdapter(new NumericWheelAdapter(1, 12));
                    //重新设置日
                    setReDay(year_num, wv_month.getCurrentItem() + 1, isFullMonth ? 0 : 1, 31, list_big, list_little);
                }
            ...
            public void onItemSelected(int index) {
                ...
                if (startYear == endYear) {
                    ...
                    if (startMonth == endMonth) {
                        ...
                        setReDay(currentYear, month_num, isFullMonth ? 0 : 1, endDay, list_big, list_little);
                    } else {
                        setReDay(currentYear, month_num, isFullMonth ? 0 : 1, 31, list_big, list_little);
                    }
                    ...
                    if (month_num == endMonth) {
                        //重新设置日
                        setReDay(currentYear, wv_month.getCurrentItem() + 1, isFullMonth ? 0 : 1, endDay, list_big, list_little);
                    } else {
                        setReDay(currentYear, wv_month.getCurrentItem() + 1, isFullMonth ? 0 : 1, 31, list_big, list_little);
                    }
...
//                maxItem = endD;
    ...
    public boolean isFullMonth() {
        ...
        int value = wv_day.getCurrentItem();
        return value == 0;
    }
           ...
           /* int i = wv_month.getCurrentItem() + startMonth;
            ...
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        ...
                        .append(isFullMonth ? (value == 0 ? 1 : wv_day.getCurrentItem() + startDay) : wv_day.getCurrentItem() + startDay).append(" ")
                ...
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        .append((wv_month.getCurrentItem() + startMonth)).append("-")
                        .append(isFullMonth ? (value == 0 ? 1 : wv_day.getCurrentItem()) : wv_day.getCurrentItem() + 1).append(" ")
                        .append(wv_hours.getCurrentItem()).append(":")
                        .append(wv_minutes.getCurrentItem()).append(":")
                        .append(wv_seconds.getCurrentItem());
            }
    ...
    public String getEndTime() {
        ...
        if (currentYear == startYear) {
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                    .append((wv_month.getCurrentItem() + startMonth)).append("-")
                    .append(isFullMonth ? (value == 0 ? wv_day.getAdapter().getItemsCount() - 1 : wv_day.getCurrentItem() + startDay) : wv_day.getCurrentItem() + startDay).append(" ")
                    .append(wv_hours.getCurrentItem()).append(":")
                    .append(wv_minutes.getCurrentItem()).append(":")
                    .append(wv_seconds.getCurrentItem());
            } else {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                    .append((wv_month.getCurrentItem() + startMonth)).append("-")
                    .append(isFullMonth ? (value == 0 ? wv_day.getAdapter().getItemsCount() - 1 : wv_day.getCurrentItem()) : wv_day.getCurrentItem() + 1).append(" ")
                    .append(wv_hours.getCurrentItem()).append(":")
                    .append(wv_minutes.getCurrentItem()).append(":")
                    .append(wv_seconds.getCurrentItem());
            }
