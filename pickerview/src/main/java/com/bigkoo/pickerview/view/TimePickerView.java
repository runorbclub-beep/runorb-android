...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        wheelTime = new WheelTime(timePickerView, mPickerOptions.type, mPickerOptions.isFullMonth, mPickerOptions.textGravity, mPickerOptions.textSizeContent);
    ...
    private void setTime() {
        ...
        wheelTime.setPicker(year, month, mPickerOptions.isFullMonth ? day + 1 : day, hours, minute, seconds);
    }
    ...
    public void returnData() {
        if (mPickerOptions.timeSelectListener != null) {
            try {
                Date startDate = WheelTime.dateFormat.parse(wheelTime.getTime());
                Date endDate = WheelTime.dateFormat.parse(wheelTime.getEndTime());
                boolean isFullMonth = wheelTime.isFullMonth();
                mPickerOptions.timeSelectListener.onTimeSelect(startDate, endDate, isFullMonth, clickView);
            } catch (ParseException e) {
                e.printStackTrace();
            }
        }
