...
public class PayEditText extends LinearLayout {
    ...
    public void setInputType(int type){
        tvFirst.setInputType(type);
        tvSecond.setInputType(type);
        tvThird.setInputType(type);
        tvForth.setInputType(type);
        tvFifth.setInputType(type);
        tvSixth.setInputType(type);
    }
