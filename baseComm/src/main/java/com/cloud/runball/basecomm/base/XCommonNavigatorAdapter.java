 ...
 * @Version: 1.0
 */
public class XCommonNavigatorAdapter extends CommonNavigatorAdapter {
  ...
  public XCommonNavigatorAdapter() {

  }

  public XCommonNavigatorAdapter(String[] tles){
    titles = tles;
  }

  public XCommonNavigatorAdapter(String[] tles, TabItemClickListener listener) {
    titles = tles;
  ...
  public void setTitleViewText(String[] titles) {
    this.titles = titles;
  ...
  public IPagerTitleView getTitleView(Context context, int index) {
    ...
    colorTransitionPagerTitleView.setNormalColor(mNormalColor);
    colorTransitionPagerTitleView.setSelectedColor(mSelectedColor);
    colorTransitionPagerTitleView.setText(titles[index]);
    colorTransitionPagerTitleView.setTextSize(mSize);
