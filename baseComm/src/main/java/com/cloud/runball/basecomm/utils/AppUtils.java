...
public class AppUtils {
     ...
     * @return
     */
    public static boolean copyStringToClipboard(Context ctx,String text) {
        try {
            if (Build.VERSION.SDK_INT > 11) {
                ...
                android.text.ClipboardManager clipboardManager = (android.text.ClipboardManager) ctx.getSystemService(Context.CLIPBOARD_SERVICE);
     ...
     * @return
     */
    public static String getStringClipboard(Context ctx) {
        String clipResult = null;
        if (Build.VERSION.SDK_INT > 11) {
            ClipboardManager c = (ClipboardManager) ctx.getSystemService(Context.CLIPBOARD_SERVICE);
            ...
            android.text.ClipboardManager c = (android.text.ClipboardManager) ctx.getSystemService(Context.CLIPBOARD_SERVICE);
