 ...
 * @author ns467
 */
public class PermissionWallUtils {

    static Context context;
    private PermissionWallUtils(){}
     ...
     * 跳转到miui的权限管理页面
     */
    static void gotoMiuiPermission() {
        try { // MIUI 8
     ...
     * 跳转到魅族的权限管理系统
     */
    static void gotoMeizuPermission() {
        try {
     ...
     * 华为的权限管理页面
     */
    static void gotoHuaweiPermission() {
        try {
     ...
     * @return
     */
    static Intent getAppDetailSettingIntent() {
