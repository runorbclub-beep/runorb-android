...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.pickerview_wheelview_textColorOut, 0xFF767779);
            textColorCenter = a.getColor(R.styleable.pickerview_wheelview_textColorCenter, 0xFFFFFFFF);
            dividerColor = a.getColor(R.styleable.pickerview_wheelview_dividerColor, 0x00d5d5d5);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle > 90F || angle < -90F) {
                ...
                if ("00".equals(getContentText(showText))) {
                    contentText = "全部";
                } else if (!isCenterLabel && !TextUtils.isEmpty(label) && !TextUtils.isEmpty(getContentText(showText))) {
