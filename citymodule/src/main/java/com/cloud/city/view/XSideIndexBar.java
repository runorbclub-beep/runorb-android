 ...
 * @Date: 2018/2/8 10:56
 */
public class XSideIndexBar extends View{
    ...
    public XSideIndexBar(Context context) {
        this(context, null);
    }

    public XSideIndexBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XSideIndexBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public XSideIndexBar setOverlayTextView(TextView overlay){
        this.mOverlayTextView = overlay;
        return this;
    }

    public XSideIndexBar setOnIndexChangedListener(OnIndexTouchedChangedListener listener){
