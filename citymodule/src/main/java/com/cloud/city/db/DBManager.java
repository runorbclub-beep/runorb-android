...
import static com.cloud.city.db.DBConfig.COLUMN_C_CODE;
import static com.cloud.city.db.DBConfig.COLUMN_C_NAME;
import static com.cloud.city.db.DBConfig.COLUMN_C_PINYIN;
import static com.cloud.city.db.DBConfig.COLUMN_C_PROVINCE;
import static com.cloud.city.db.DBConfig.DB_NAME_V2;
import static com.cloud.city.db.DBConfig.LATEST_DB_NAME;
import static com.cloud.city.db.DBConfig.DB_NAME_V1;
import static com.cloud.city.db.DBConfig.TABLE_NAME;
/**
...
public class DBManager {
    ...
    public City getCountries(String CountryCode) {
        SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase(DB_PATH + LATEST_DB_NAME, null);
        Cursor cursor = db.rawQuery("select * from countries where code = '" + CountryCode + "'", null);
        City city = null;
        while (cursor.moveToNext()){
            String name = cursor.getString(cursor.getColumnIndex("name"));
            String code = cursor.getString(cursor.getColumnIndex("code"));
            city = new City(name, null, name, code);
        }
        cursor.close();
        db.close();
        return city;
