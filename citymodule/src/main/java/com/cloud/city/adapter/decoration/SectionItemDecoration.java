package com.cloud.city.adapter.decoration;
...
public class SectionItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionItemDecoration(Context context, List<City> data) {
        ...
        mBgSectionPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mBgSectionPaint.setColor(Color.parseColor("#26282C"));
    ...
    private void drawSection(Canvas c, int left, int right, View child,
        ...
        c.drawRect(left,
                ...
                right,
                child.getTop() - params.topMargin, mBgSectionPaint);
