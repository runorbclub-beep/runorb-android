...
public class CircleProgress extends View {
    ...
    private int[] mGradientColors = {Color.argb(255,253,232,51),Color.argb(255,254,94,88),Color.argb(255,255,173,142)};
    //当前进度，[0.0f,1.0f]
     ...
     * @param value
     */
    public void initValue2(float value) {
        if (value > mMaxValue) {
            value = mMaxValue;
        }
    ...
    public void setValue(float value, boolean anim) {
        ...
        if(anim){
            tempAnimTime = value <= 2 ? 400 : mAnimTime;
        }else{
            tempAnimTime = 400;
        }
        startAnimator(start, end, tempAnimTime);
    }
